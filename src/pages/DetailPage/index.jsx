...
const DetailPage = () => {
  ...
  const formatPokemonStats = ([
    ...
    statSPD
      ...
      { name: 'Special Defense', baseStat: statDEP.base_stat },
      { name: 'Speed', baseStat: statSPD.base_stat }
    ]


  const formatPokemonAbilities = (abilities) => {
    return abilities.filter((e, index) => index <= 1)
  ...
  return (
    <article className='flex items-center gap-1 flex-col w-full'>
      <div
        ...
        <section className='w-full min-h-[65%] h-full bg-gray-800 z-10 pt-14 flex flex-col items-center gap-3 px-5'>
          ...
          <div className='w-full'>
              <table>
                <tbody>
                  ...
                  <p className = 'text-sm leading-4 font-sans text-zinc-200 max-w-[30rem] text-center'>
                  {pokemon.description}
